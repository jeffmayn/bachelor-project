...
{
       0,   118,   118,   122,   126,   127,   128,   129,   130
};
#endif
...
static const char *const yytname[] =
{
  ...
  "tLPAR", "tRPAR", "tLSQ", "tRSQ", "tLCURL", "tRCURL", "'-'", "'*'",
  "'/'", "$accept", "program", "exp", "term", YY_NULLPTR
};
#endif
